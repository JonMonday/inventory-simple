...
let ImportsController = class ImportsController {
    ...
    async importInventory(file, req) {
...
__decorate([
    ...
    (0, permissions_decorator_1.Permissions)('imports.create'),
...
], ImportsController.prototype, "importInventory", null);
__decorate([
    (0, common_1.Get)('status/:jobId'),
    (0, permissions_decorator_1.Permissions)('imports.read'),
